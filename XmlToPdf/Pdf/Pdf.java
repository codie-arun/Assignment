...
public class Pdf {
    ...
    static BillObject mybill;

    public static void main(String[] args) throws Exception{
    	
    	BillObject bill = new BillObject();
    	Pdf.mybill = bill.convert("bill.xml");
		System.out.println(bill.customername);
		System.out.println(bill.billno);
		System.out.println(bill.billDate);
...
//        subCatPart = catPart.addSection(subPara);
        subCatPart.add(new Paragraph("Customer Name : "+mybill.customername));
        subCatPart.add(new Paragraph("Bill No : "+mybill.billno));
        subCatPart.add(new Paragraph("Bill Date : "+mybill.billDate));
...
//        document.add(catPart);
    ...
    private static void createTable(Section subCatPart)
        ...
        for(ArrayList<String> item: mybill.item.values()) {
        	for(String i:item) {
        		table.addCell(i);
        	}
        }
